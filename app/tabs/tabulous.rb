Tabulous.setup do
  ...
  tabs do
    ...
    vivocameras_tab do
      ...
      visible_when  { true }
      enabled_when  { true }
      active_when   { in_action('any').of_controller('vivocameras') }
    end

    vivocamera_userinputs_tab do
      text          { 'Vivocamera Userinputs' }
      link_path     { root_path }
      visible_when  { true }
      enabled_when  { true }
      active_when   { in_action('any').of_controller('vivocamera_userinputs') }
    end
